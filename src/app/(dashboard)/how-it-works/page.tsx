...
const SECTIONS = [
  {
    ...
    body: [
      ...
      "From the Clients page, use \"+ Add client\" to create one. Open a client to edit its details, add or edit contacts inline, and see every deal tied to that client.",
    ],
  },
  {
    ...
    href: "/pipeline",
    body: [
      "Every deal moves through a set of stages — Lead, Contacted, Qualified, Proposal, Negotiation, Won, Lost — shown as columns on the Pipeline board.",
