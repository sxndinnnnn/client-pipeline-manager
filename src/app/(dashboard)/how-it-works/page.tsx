...
const SECTIONS = [
  {
    ...
    body: [
      ...
      "The Deals tab works the same way — a table of the client's deals, and + Add Deal opens the create form as a modal. Each row has View, Edit, and Delete icons; View and Edit open the deal's full detail (value, source, dates, activity log, tasks) in a modal too, without leaving the client page.",
